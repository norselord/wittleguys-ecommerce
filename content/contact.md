  ...
  <div class="max-w-screen-md px-4 mx-auto">
      ...
      <form id="contactForm" class="space-y-8">
          ...
          <div class="my-4 sm:col-span-2">
              ...
              <textarea id="message" name="message" rows="10" maxlength="2000" class="block p-2.5 w-full text-md text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500" placeholder="Leave a comment..." required></textarea>
          </div>
